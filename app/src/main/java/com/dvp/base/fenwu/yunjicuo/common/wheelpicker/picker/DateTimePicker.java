package com.dvp.base.fenwu.yunjicuo.common.wheelpicker.picker;
...
import com.dvp.base.fenwu.yunjicuo.common.wheelpicker.utils.DateUtils;
import com.dvp.base.fenwu.yunjicuo.common.wheelpicker.widget.WheelView;
...
public class DateTimePicker extends WheelPicker {
     ...
     * @param day
     */
    public void setSelectedItem(int year, int month, int day/*, int hour, int minute*/) {//解决界面调用时间和分钟错误，必须注释掉 hour minute
