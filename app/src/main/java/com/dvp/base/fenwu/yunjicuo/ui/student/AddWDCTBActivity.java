...
public class AddWDCTBActivity extends CommonActivity implements SelectDialog.ItemClickInterface,MultiSelectDialog.multiselectCallBack
{
    ...
    public void OnHttpResponse(String var1, String var2)
    {
        ...
        if(var1.equals(getResources().getString(R.string.stu_add_wodecuotiben_gettihao_trancode)))//获取题号
        {
            ...
            //显示我的题号选择列表
            multiSD = new MultiSelectDialog(AddWDCTBActivity.this,mTiHaoList,this);
            multiSD.show();
        }
        ...
        if(var1.equals(getResources().getString(R.string.stu_add_wodecuotiben_getyema_trancode)))//获取页码
        {
            ...
            DialogUtil.getMultiChoiceDialog(AddWDCTBActivity.this, "页码选择", 0, null, yemaList, new MaterialDialog.ListCallbackMultiChoice()
            {
                @Override
        ...
        if(var1.equals(getResources().getString(R.string.stu_add_wodecuotiben_trancode)))
        {
            ...
            mOneList.add("我的书架");
            mOneList.add("班级练习册");
            DialogUtil.getListDialog(AddWDCTBActivity.this, "请选择联系册或者试卷", 0, mOneList, new MaterialDialog.ListCallback()
            {
                @Override
                public void onSelection(MaterialDialog dialog, View itemView, int which, CharSequence text)
                {
                    if (which == 0)
                    {
                        sdWDSJ = new SelectDialog(AddWDCTBActivity.this,mWDSJMap,AddWDCTBActivity.this);
                        sdWDSJ.show();
                    }
                    if(which == 1)
                    {
                        sdBJLXC = new SelectDialog(AddWDCTBActivity.this,mBanJLXCMap,AddWDCTBActivity.this);
                        sdBJLXC.show();
                    }
                }
            }).show();
