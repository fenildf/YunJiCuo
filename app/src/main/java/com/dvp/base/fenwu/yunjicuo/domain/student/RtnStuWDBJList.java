...
/**
 * 作者：Administrator on 2016/5/31 17:35
 * <p/>
 * 功能描述:我的班级列表
 */
public class RtnStuWDBJList
{
     ...
     * pageSize : 3
     * orderCondition :
     * searchCondition :  where  user.id ='e54910245143f903015146aa3ab6042c' and str(isValid) ='1' and str(type) !='0'
