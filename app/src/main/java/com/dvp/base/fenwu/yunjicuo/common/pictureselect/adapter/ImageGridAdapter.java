...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(isShowCamera()){
            if(i == 0){
                view = mInflater.inflate(R.layout.multimg_selector_list_item_camera, viewGroup, false);
                return view;
            }
        }
        ...
        ViewHolder holder;
        if(view == null){
            view = mInflater.inflate(R.layout.multimg_selector_list_item_image, viewGroup, false);
