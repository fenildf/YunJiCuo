...
public class StuWDBJCuoTTJActivity extends CommonActivity implements MyTimePickerYearMonthDayListener,SelectDialog.ItemClickInterface
{
    ...
    public void OnHttpResponse(String var1, String var2)
    {
        if(var1.equals(getResources().getString(R.string.teacher_banjicuotiben_cuotitongji_getlianxice_trancode)))
        {
            ...
            else
            {
                ...
                lianxcSD = new SelectDialog(StuWDBJCuoTTJActivity.this,mLianXCMap,this);
                lianxcSD.show();
            }
        }
        ...
        if(var1.equals(getResources().getString(R.string.tea_cuotitongji_getyema_trancode)))   //获取页码结果
        {
            ...
            DialogUtil.getMultiChoiceDialog(StuWDBJCuoTTJActivity.this, "页码选择", 0, null, yemaList, new MaterialDialog.ListCallbackMultiChoice()
            {
                @Override
